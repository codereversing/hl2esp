...
using model_t = void;
using SurfInfo = void;
using IMaterial = void;
using player_info_t = void;
using client_textmessage_t = void;
using CAudioSource = void;
using CSentence = void;
using ButtonCode_t = void;
using ISpatialQuery = void;
using IMaterialSystem = void;
using AudioState_t = void;
using INetChannelInfo = void;
using CPhysCollide = void;
using matrix3x4_t = void;
using color32 = void;
using vmode_s = void;
using OcclusionParams_t = void;
using SkyboxVisibility_t = void;

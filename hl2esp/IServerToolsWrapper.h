...
public:
    ...
    virtual bool SnapPlayerToPosition(const Vector3& org, const QAngle& ang, IClientEntity* pClientPlayer = nullptr) = 0;
    virtual bool GetPlayerPosition(Vector3& org, QAngle& ang, IClientEntity* pClientPlayer = nullptr) = 0;
    ...
    virtual bool SetKeyValue(CBaseEntity* pEntity, const char* szField, const Vector3& vecValue) = 0;
    ...
    virtual void AddOriginToPVS(const Vector3& org) = 0;
    virtual void MoveEngineViewTo(const Vector3& vPos, const QAngle& vAngles) = 0;
    ...
    virtual void RadiusDamage(const CTakeDamageInfo* info, const Vector3& vecSrc, float flRadius, int iClassIgnore, CBaseEntity* pEntityIgnore) = 0;
